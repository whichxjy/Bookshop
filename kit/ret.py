...
from ui.retdialog import Ui_ReturnDialog
from kit import db

class ReturnDialog(QtWidgets.QDialog):
    def __init__(self, parent=None):
        super().__init__(parent=parent)
        self.ui = Ui_ReturnDialog()
    ...
    def on_submit_btn_clicked(self):
        ...
        # Return book(s)
        self.return_book(book_id, quantity)
    ...
    def return_book(self, book_id, quantity):
        ...
        try:
            ...
            # Add return record to return record table
            with conn.cursor() as cursor:
                sql = """
                    INSERT INTO return_record
                    (book_id, ret_quantity)
                    VALUES
                    ({0}, {1})
