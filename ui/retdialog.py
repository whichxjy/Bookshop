...
class Ui_ReturnDialog:
    def setupUi(self, ReturnDialog):
        ...
        ReturnDialog.resize(300, 300)
        ReturnDialog.setMinimumSize(QtCore.QSize(300, 300))
        ReturnDialog.setMaximumSize(QtCore.QSize(300, 300))
        self.gridLayout = QtWidgets.QGridLayout(ReturnDialog)
        self.gridLayout.setObjectName("gridLayout")
        self.back_frame = QtWidgets.QFrame(ReturnDialog)
    ...
    def retranslateUi(self, ReturnDialog):
        ReturnDialog.setWindowTitle(QtWidgets.QApplication.translate("ReturnDialog", "Return", None, -1))
        self.book_id_Label.setText(QtWidgets.QApplication.translate("ReturnDialog", "Book ID:", None, -1))
        self.quantity_Label.setText(QtWidgets.QApplication.translate("ReturnDialog", "Quantity:", None, -1))
        self.submit_Btn.setText(QtWidgets.QApplication.translate("ReturnDialog", "Submit", None, -1))
