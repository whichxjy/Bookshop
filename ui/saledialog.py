...
class Ui_SaleDialog:
    def setupUi(self, SaleDialog):
        ...
        SaleDialog.resize(300, 300)
        SaleDialog.setMinimumSize(QtCore.QSize(300, 300))
        SaleDialog.setMaximumSize(QtCore.QSize(300, 300))
        self.gridLayout = QtWidgets.QGridLayout(SaleDialog)
        self.gridLayout.setObjectName("gridLayout")
        self.back_frame = QtWidgets.QFrame(SaleDialog)
    ...
    def retranslateUi(self, SaleDialog):
        SaleDialog.setWindowTitle(QtWidgets.QApplication.translate("SaleDialog", "Sale", None, -1))
        self.book_id_Label.setText(QtWidgets.QApplication.translate("SaleDialog", "Book ID:", None, -1))
        self.quantity_Label.setText(QtWidgets.QApplication.translate("SaleDialog", "Quantity:", None, -1))
        self.submit_Btn.setText(QtWidgets.QApplication.translate("SaleDialog", "Submit", None, -1))
